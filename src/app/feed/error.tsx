...
export default function FeedError({
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 py-20 md:py-28">
      ...
      <h1 className="mt-5 font-serif text-2xl font-medium tracking-tight md:text-3xl">
