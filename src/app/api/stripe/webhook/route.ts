  ...
  if (
    ...
    if (sub) {
      try {
        ...
        console.error("[stripe webhook] apply subscription failed", e);
...
async function applySubscription(db: ReturnType<typeof createAdminClient>, sub: Stripe.Subscription): Promise<void> {
