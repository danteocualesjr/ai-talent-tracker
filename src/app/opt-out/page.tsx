        ...
        <div className="container max-w-xl pb-16">
          <div className="mb-6 grid gap-3 sm:grid-cols-3">
            {TRUST_ITEMS.map(({ icon: Icon, title, body }) => (
              <div key={title} className="surface-card surface-card-hover group relative overflow-hidden p-4 text-center sm:text-left">
                ...
                <div className="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-lg border border-border/60 bg-signal/10 text-signal transition-all motion-safe:group-hover:scale-105 motion-safe:group-hover:border-signal/30 sm:mx-0">
