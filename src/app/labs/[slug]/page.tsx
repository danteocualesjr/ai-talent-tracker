      ...
      <main className="flex-1">
        <section className="relative overflow-hidden border-b">
          ...
          <div className="container relative py-12">
            <Button asChild variant="ghost" size="sm" className="-ml-3 mb-4 text-muted-foreground">
              <Link href="/labs"><ArrowLeft className="mr-1 h-4 w-4" /> All labs</Link>
            </Button>
            <div className="flex items-center gap-5">
              ...
              <div>
                <h1 className="text-4xl font-semibold tracking-tighter">{lab.name}</h1>
        ...
        <section className="container max-w-4xl py-10">
          <div className="rounded-xl border bg-card">
            <div className="border-b px-5 py-3 text-sm font-semibold">{people.length} tracked employees</div>
            {people.length === 0 ? (
