...
export function EventListItem({ event, profile, href }: { event: EventRowT; profile: Profile; href?: string }) {
  ...
  return (
    <div className="group relative flex items-start gap-4 px-5 py-4 transition-all duration-200 odd:bg-muted/[0.12] hover:bg-muted/40 focus-within:bg-muted/30 focus-within:ring-2 focus-within:ring-inset focus-within:ring-signal/20 motion-safe:hover:shadow-[inset_3px_0_0_0_hsl(var(--signal)/0.35),inset_0_0_0_1px_hsl(var(--border)/0.5)]">
