...
export function DashboardPreview() {
  return (
    <div className="preview-tilt preview-glow overflow-hidden rounded-2xl border border-border/80 bg-card">
  ...
  return (
    <div className="rounded-xl border border-border/60 bg-card p-3.5 shadow-sm">
      ...
      <div className="mt-1.5 flex items-baseline gap-2">
        ...
        <div className={`tnum text-[11px] font-semibold ${color}`}>{delta}</div>
      </div>
    </div>
  );
}
