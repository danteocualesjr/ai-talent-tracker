...
const badgeVariants = cva(
  "inline-flex items-center gap-1 rounded-full border px-2.5 py-0.5 text-[11px] font-semibold leading-none tracking-tight transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-signal/35 focus-visible:ring-offset-2 focus-visible:ring-offset-background",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "border-border/70 bg-transparent text-foreground hover:border-signal/30 hover:bg-signal/5",
        destructive:
        ...
        muted:
          "border-border/50 bg-muted/50 text-muted-foreground shadow-none",
      },
    },
