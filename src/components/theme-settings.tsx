      ...
      {OPTIONS.map(({ value, label, icon: Icon }) => {
        ...
        return (
          <button
            ...
            className={cn(
              "group flex flex-col items-center gap-2 rounded-xl border px-4 py-4 text-sm transition-all duration-200",
              active
                ? "border-signal/40 bg-signal/5 font-medium text-foreground shadow-sm ring-1 ring-signal/20"
