...
export function LiveBadge() {
  return (
    <div className="surface-glass inline-flex items-center gap-2 rounded-full border border-signal/20 px-3.5 py-1.5 text-[11px] font-medium text-muted-foreground transition-all duration-200 hover:border-signal/30 hover:shadow-[0_0_12px_-2px_hsl(var(--signal)/0.35)]">
