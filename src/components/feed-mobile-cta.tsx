...
export function FeedMobileCta() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-20 border-t border-signal/25 bg-background/95 px-4 pt-3 shadow-[0_-16px_40px_-12px_hsl(var(--foreground)/0.14),0_0_0_1px_hsl(var(--signal)/0.08)] backdrop-blur-xl sm:hidden pb-[max(0.75rem,env(safe-area-inset-bottom))]">
