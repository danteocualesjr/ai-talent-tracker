    ...
    <>
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className={cn(
              "absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-signal px-1 text-[9px] font-bold text-[hsl(var(--signal-foreground))]",
              unreadCount > 0 && "signal-pulse",
            )}>
