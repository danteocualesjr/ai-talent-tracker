...
export function AppTopbar({ email, orgPlan, unreadCount = 0 }: Props) {
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-20 hidden h-[60px] items-center gap-3 border-b border-border/60 bg-background/75 px-5 shadow-[0_1px_0_0_hsl(var(--border)/0.4),0_12px_32px_-24px_hsl(var(--foreground)/0.12)] backdrop-blur-xl md:flex">
