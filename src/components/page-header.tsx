    ...
    >
      ...
      <div className="min-w-0">
        ...
        <div className="flex items-center gap-3">
          {icon && (
            <span aria-hidden="true" className="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-border/70 bg-card text-foreground shadow-sm ring-1 ring-transparent transition-[box-shadow,ring-color] group-hover/header:ring-signal/15">
              <span className="pointer-events-none absolute inset-0 rounded-md bg-gradient-to-br from-signal/8 to-transparent opacity-0 transition-opacity group-hover/header:opacity-100" />
              {icon}
            </span>
          )}
          <h1
