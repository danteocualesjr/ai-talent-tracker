...
export function renderEventEmail(args: {
  ...
  const linkedinHref = safeHttpsUrl(args.linkedinUrl);
  ...
  const html = `
    <div style="font-family:-apple-system,Segoe UI,sans-serif;max-width:560px;margin:auto;padding:24px">
      ...
      <p style="margin-top:24px">
        ${linkedinHref ? `<a href="${escapeHtml(linkedinHref)}" style="display:inline-block;padding:8px 14px;background:#111;color:#fff;text-decoration:none;border-radius:6px">View LinkedIn</a>` : ""}
      </p>
