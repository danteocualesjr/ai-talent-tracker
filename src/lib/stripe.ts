...
const CHECKOUT_PRICE_IDS = [process.env.STRIPE_PRICE_PRO, process.env.STRIPE_PRICE_TEAM].filter(
  (id): id is string => Boolean(id),
);

/** Server-side allowlist for checkout — rejects arbitrary Stripe price IDs. */
