...
export const ALLOWED_STRIPE_PRICE_IDS = new Set(Object.keys(PRICE_PLAN_MAP));

export function stripeCustomerId(customer: string | Stripe.Customer | Stripe.DeletedCustomer): string {
