-- Restrict event reads: public events for everyone; private events for orgs watching the profile.
...
create policy "watchers can read profile events" on public.events
  for select using (
    profile_id in (
