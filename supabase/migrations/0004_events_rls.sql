-- Restrict event reads: public feed only sees is_public rows; org members see watched profiles.
...
create policy "org members read watched events" on public.events
  for select using (
    profile_id in (
